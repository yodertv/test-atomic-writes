...
-------- 	| ---								| -------
Golang 		| https://golang.org 	    		| Programing language
golang    	| https://github.com/golang/go 		| Go source code

## Issues
- Write in append mode in Mac OS X doesn't appear to be atomic
...
s 500013 -w 100
Each line of file out.tmp will be 500013 bytes, writen by 100 workers, writing 50 lines ea
ch.
